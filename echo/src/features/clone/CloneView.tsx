...
import { loadCloneMe, pauseClone, resumeClone } from '../../api/clone';
    ...
    <div className="pb-24 px-6">
      ...
      <div className="mt-8 flex flex-col items-center">
        ...
        <div className="mt-4 text-center">
          ...
          {persona && (
            <p className="text-xs text-gray-500 mt-2 max-w-xs line-clamp-3">{persona}</p>
          )}
        </div>

        <div className="mt-8 w-full grid grid-cols-2 gap-4">
          <div className="p-4 bg-echo-card rounded-2xl border border-white/5">
            <p className="text-xs text-gray-500 mb-1">性格画像</p>
            <div className="flex flex-wrap gap-1">
              {['理性', '幽默', '极简', '摇滚爱好者'].map((t) => (
                <span
                  key={t}
