...
| P1-12 | WebSocket live updates (optional) | — | `echo` optional | `wss://.../v1/ws` | Redis pub/sub | `services/api` | done | n/a | done | n/a | `echo:live` channel; match/handoff/affinity/feed push to `/v1/ws` |
...
|---------|------|---------|
| 1.1.11 | 2026-05-26 | P1-12 WebSocket live: Redis `echo:live`, `/v1/ws`, echo auto-refresh |
