...
new Worker(
  ...
  async (job) => {
    ...
    logger.info('post drafted', { trigger: trigger ?? 'manual', postId: post.id });
  },
  { connection },
);
...
console.log(
  'Echo worker started (post-draft, moderation, match-daily, agent-turn, report-triage, manual-review, clone-runtime)',
);
